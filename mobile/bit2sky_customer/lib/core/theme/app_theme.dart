...
class AppTheme {
  ...
  static ThemeData build(BrandingConfig branding) {
    ...
    return ThemeData(
      ...
      // Defense-in-depth for the stuck-SnackBar defect: even a SnackBar shown
      // without the shared helper floats above the dock and self-dismisses.
      snackBarTheme: const SnackBarThemeData(
        behavior: SnackBarBehavior.floating,
        insetPadding: EdgeInsets.fromLTRB(
            AppSpacing.s16, 0, AppSpacing.s16,
            AppSpacing.bottomNavHeight + AppSpacing.s16),
