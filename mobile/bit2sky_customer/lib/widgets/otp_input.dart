...
class OtpInput extends StatefulWidget {
  final int length;
  final bool error;
  final String? initialValue; // dev: prefill the boxes with the echoed OTP
...
class _OtpInputState extends State<OtpInput> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    // Prefill from a dev-echoed OTP so login works without a live inbox.
    final v = widget.initialValue;
    if (v != null && v.length == widget.length) {
